package net.everla.everlaartifacts.server.handlers.blocks.auric_ore;
...
public class MakeEntityFlyHandler {
    // 全局音效冷却：记录上一次播放音效的服务器游戏 tick（所有维度共享）
    private static long lastSoundTick = -1L;

    public static void handleMakeEntityFly(LevelAccessor world, Entity entity) {
