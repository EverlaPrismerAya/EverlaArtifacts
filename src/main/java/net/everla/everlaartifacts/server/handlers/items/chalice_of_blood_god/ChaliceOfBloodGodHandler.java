package net.everla.everlaartifacts.server.handlers.items.chalice_of_blood_god;
...
public class ChaliceOfBloodGodHandler {
	public static void handleChaliceOfBloodGodRegenerate(Entity entity) {
		if (entity == null)
			return;
