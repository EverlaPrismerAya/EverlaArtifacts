...
public class BraisedPorkWithPlumCabbageHandler {
    
    public static void handleBraisedPorkWithPlumCabbage(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity == null)
            return;
