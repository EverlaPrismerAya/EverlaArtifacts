package net.everla.everlaartifacts.server.handlers.items.nilk;
...
public class NilkDiscHandler {
	public static void handleNilkDisc(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		{
			Entity _ent = entity;
