...
public class ModelPlayerModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("everlaartifacts", "model_player_model"), "main");
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.Body.yRot = headPitch / (180F / (float) Math.PI);
	}
}
