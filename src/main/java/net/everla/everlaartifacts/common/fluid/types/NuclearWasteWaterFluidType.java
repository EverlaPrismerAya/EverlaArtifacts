...
package net.everla.everlaartifacts.common.fluid.types;
...
public class NuclearWasteWaterFluidType extends FluidType {
	public NuclearWasteWaterFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("everlaartifacts:block/nuclear_waste_water");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("everlaartifacts:block/nuclear_waste_water_flow");
